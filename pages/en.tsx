                ...
                <div className="sr__content-text">
                  <p className="right">
                    ...
                    <span className="marker">
                      Sweden's highest salary for home cleaning maids, Servia
                      AB.
                    </span>{" "}
                    We do it simultaneously in the three largest cities in
                    Sweden: <span className="marker">Stockholm, Göteborg,</span>
                  ...
                  <p>
                    ...
                    <i>
                      {" "}
                      (To get the approximate amounts in euros, divide the
                      numbers by ten.)
                    </i>
                  </p>
                  ...
                  <p>
                    ...
                    of <span className="marker">34,986 kr per month</span>{" "}
                    (31,243 kr plus 3,743 kr in holiday salary) plus 31.42% in
                    social security charges, that is, a total of 45,997 kr per
                    month).
                  </p>
                  ...
                  <p>
                    ...
                    English: in short,{" "}
                    <span className="marker">elite maids</span> for Swedish
                    homes with the{" "}
                    <span className="marker">
                  ...
                  <p>
                    And because we can run the business at what’s most likely
                    the lowest premium in the industry
                    <span className="marker">
                  ...
                  <p>
                    The only thing clients pay is the very highest salary for
                    the very best maids for the hours they work plus a minimal
                    premium of 45% to run the business.
                  </p>
                  ...
                  <p style={{ margin: 0 }}>
                    ...
                    employee, or through your own individual enterprise with
                    your own clients&mdash;and you receive exceptionally
                    positive feedback from your clients, and you want to
                    <span className="marker">
                      substantially increase your salary
                    </span>{" "}
                    by becoming a part of Servia, you’re most welcome to apply
                    to us.
                  </p>
                  ...
                  <p>
                    ...
                    or the company where you are currently employed as much as
                    you want, and as much as you want for Servia.
                  </p>

                  <p>
                    In other words, we don’t have any competitive clauses. We
                    don’t need this, because we’re confident that there's no
                    other home cleaning company that can compete with the salary
                    we pay.
                  </p>

                  <p>
                    To apply, <span className="marker">send your resume</span>{" "}
                    to us at
                  ...
                  <p>
                    Since we receive so many applications for these best paid
                    home cleaner jobs in Sweden, we kindly ask you for a small
                    service:{" "}
