        ...
        <div className="sr__content">
          <div className="sr__content-photoblock">
            <div
              ...
              style={{ backgroundImage: "url( ./images/photo-1.svg )" }}
            ></div>
          </div>
          ...
          <div className="sr__content-text">
            ...
            <p>
              ...
              <span className="marker">202 kr per timme</span> (180 kr plus 22
              kr i semesterersättning) plus 31,42% i sociala avgifter, alltså
              totalt 265 kr per timme.
            </p>

            <p>
              Det är massiva{" "}
              <span className="marker">50% högre lön än i kollektivavtal.</span>
            </p>

            <p className="right">
              För heltidsarbete om 40 h i veckan blir det en lön på{" "}
              <span className="marker">34 986 kr per månad</span> (31 243 kr
              plus 3 743 kr i semesterersättning) plus 31,42% i sociala
              avgifter, alltså totalt 45 977 kr per månad).
            </p>

            <p>
              Så långt vi vet, finns det inget annat städföretag i Sverige
              eller, sett till hela lönekostnaden, förmodligen ens i världen,
              som betalar sina hemstädare högre lön än Servia.
            </p>

            <p>
              Det är – så långt vi kan se –{" "}
              <span className="marker">världens högsta lön för städare.</span>
            </p>

            <p>
              Genom att betala den allra högsta lönen för hemstädare, kan vi
              rekrytera och erbjuda{" "}
              <span className="marker">de allra bästa hemstädarna</span> som
              finns att tillgå.
            </p>
            ...
            <p className="right">
              ...
              <span className="marker">elitstädare</span> för svenska hem med de{" "}
              <span className="marker">
            ...
            <p>
              Och eftersom vi kan sköta verksamheten för marknadens sannolikt
              lägsta påslag{" "}
              <span className="marker">
                – 45% på lönen jämfört med Hemfrids 145% –
              </span>{" "}
              är priset till kunderna inte högre än hos de stora städbolagen.
            </p>
            ...
            <p>
              ...
              oavsett var kunderna bor, oavsett hur ofta, hur länge och vilka
              veckodagar som kunderna bokar hemstädning.
            </p>

            <p>
              Det är att jämföra med Hemfrid som tar 498-550 kr per timme och
              HomeMaid som tar 490 kr per timme plus avgifter.
            </p>
            ...
            <p>
              Det enda kunderna betalar är den allra högsta lönen till de allra
              bästa hemstädarna för de timmar som de arbetar plus ett minimalt
              påslag om 45% för att sköta verksamheten.
            </p>
            ...
            <p style={{ margin: 0 }}>
              ...
              städfirma med egna kunder – och du får exceptionellt fina omdömen
              av dina kunder, och du vill{" "}
              <span className="marker">höja din lön markant</span> genom att bli
              en del av Servia, är du varmt välkommen att ansöka till oss.
            </p>
            ...
            <p>
              ...
              och du kan fritt välja om du vill vara anställd hos oss eller
              arbeta som underleverantör genom en egen firma eller bolag, för
              265 kr per timme plus moms.
            </p>

            <p>
              Inte minst:{" "}
              <span className="marker">
                vi tillåter dig att fortsätta att arbeta för dina egna kunder
              </span>{" "}
              eller på det företag där du idag är anställd i den utsträckning
              som du själv vill, och så mycket som du själv vill för oss.
            </p>

            <p>
              Vi har med andra ord inga konkurrensförbud. Vi behöver inga
              sådana, eftersom vi är övertygade om att det inte finns något
              företag inom hemstädning som kan konkurrera med den lön som vi
              betalar.
            </p>

            <p>
              För att ansöka, <span className="marker">skicka ditt CV</span>{" "}
              till oss på
              <span className="marker">thebestpaidmaid@servia.com,</span>{" "}
            ...
            <p>
              Eftersom vi får in så många ansökningar till dessa högst betalda
              jobb som städare i Sverige, ber vi dig om en tjänst:{" "}
              <span className="marker">undvik att ringa till oss</span> och
              vänta istället på att vi kontaktar dig. För det kommer vi att
              göra. Vi läser och vi besvarar nämligen varje ansökning vi får –
              alltid.
            </p>

            <p>
              Om du läser detta som potentiell kund och vill veta mer om Servia,
              välkomnar vi dig att ringa oss på
